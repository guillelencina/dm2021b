...
Estrategia_B  <- function()
{
  ...
  resultado2  <- gimnasio_tirar( ids_juegan2, 60)
  ...
  planilla_cazatalentos[ ids_juegan3,  tiros3 := 60]  #registro en la planilla que tiran 70 tiros
  resultado3  <- gimnasio_tirar( ids_juegan3, 60)
  ...
  planilla_cazatalentos[ ids_juegan4,  tiros4 := 60 ]  #registro en la planilla que tiran 70 tiros
  resultado4  <- gimnasio_tirar( ids_juegan4, 60)
  ...
  planilla_cazatalentos[ ids_juegan5,  tiros5 := 60 ]  #registro en la planilla que tiran 70 tiros
  resultado5  <- gimnasio_tirar( ids_juegan5, 60)
  ...
  planilla_cazatalentos[ ids_juegan6,  tiros6 := 80 ]  #registro en la planilla que tiran 200 tiros
  resultado6  <- gimnasio_tirar( ids_juegan6, 80)
