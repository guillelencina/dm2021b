...
#ronda m?s los tiros de las rondas previas (como el promedio usado para el descenso en el f?tbol)


#Para buscar la mejor tasa de elecci?n se pueden variar 
# los valores de los cuantiles a superar en cada ronda
# la cantidad de tiros en cada ronda (que es similar a lo anterior)
# llego casi a la soluci?n pero ya no se me ocurren m?s cosas que probar
# quiz?s falta probar como deberia variar la cantidad de tiros de una ronda a la siguiente
...
Estrategia_B  <- function()
{
  ...
  #De una ronda a la otra, s?lo pasan los que tuvieron igual o mayor aciertos a cierto valor de cuantil
  ...
  tiros_1= t
  tiros_2= tiros_1+m1
  tiros_3= tiros_1+m1*2
  tiros_4= tiros_1+m1*3
  tiros_5= tiros_1+m1*4
  tiros_6= tiros_1+m1*5
  tiros_7= tiros_1+m1*6
  
  #Ronda 1  ------------------------------------------------------
  #tiran los 100 jugadores es decir 1:100   x  tiros libres cada uno
  ids_juegan1  <- 1:100   #los jugadores que participan en la ronda,
  
  planilla_cazatalentos[ ids_juegan1,  tiros1 := tiros_1 ]  #registro en la planilla que tiran x tiros
  resultado1  <- gimnasio_tirar( ids_juegan1, tiros_1)
  planilla_cazatalentos[ ids_juegan1,  aciertos1 := resultado1 ]  #registro en la planilla
  
  
  #Ronda 2 -------------------------------------------------------
  
  cuantil  <- planilla_cazatalentos[ ids_juegan1, quantile(aciertos1,0.50) ]
  ids_juegan2  <- planilla_cazatalentos[ ids_juegan1 ][ aciertos1 > cuantil, id ]
  
  
  planilla_cazatalentos[ ids_juegan2,  tiros2 := tiros_2 ]  #registro en la planilla que tiran x tiros
  resultado2  <- gimnasio_tirar( ids_juegan2, tiros_2)
  ...
  cuantil  <- planilla_cazatalentos[ ids_juegan2, quantile(aciertos2,0.50) ]
  ids_juegan3  <- planilla_cazatalentos[ ids_juegan2 ][ aciertos2 > cuantil, id ]
  
  
  
  planilla_cazatalentos[ ids_juegan3,  tiros3 := tiros_3]  #registro en la planilla que tiran x tiros
  resultado3  <- gimnasio_tirar( ids_juegan3, tiros_3)
  ...
  cuantil  <- planilla_cazatalentos[ ids_juegan3, quantile(aciertos3,0.50) ]
  ids_juegan4  <- planilla_cazatalentos[ ids_juegan3 ][ aciertos3 > cuantil, id ]
  
  
  
  planilla_cazatalentos[ ids_juegan4,  tiros4 := tiros_4 ]  #registro en la planilla que tiran x tiros
  resultado4  <- gimnasio_tirar( ids_juegan4, tiros_4)
  ...
  cuantil  <- planilla_cazatalentos[ ids_juegan4, quantile(aciertos4,0.50) ]
  ids_juegan5  <- planilla_cazatalentos[ ids_juegan4 ][ aciertos4 > cuantil, id ]
  
  
  
  planilla_cazatalentos[ ids_juegan5,  tiros5 := tiros_5 ]  #registro en la planilla que tiran x tiros
  resultado5  <- gimnasio_tirar( ids_juegan5, tiros_5)
  ...
  cuantil  <- planilla_cazatalentos[ ids_juegan5, quantile(aciertos5,0.50) ]
  ids_juegan6  <- planilla_cazatalentos[ ids_juegan5 ][ aciertos5 > cuantil, id ]
  
  
  
  planilla_cazatalentos[ ids_juegan6,  tiros6 := tiros_6 ]  #registro en la planilla que tiran x tiros
  resultado6  <- gimnasio_tirar( ids_juegan6, tiros_6)
  ...
  cuantil  <- planilla_cazatalentos[ ids_juegan6, quantile(aciertos6,0.50) ]
  ids_juegan7  <- planilla_cazatalentos[ ids_juegan6 ][ aciertos6 >= cuantil, id ]
  
  
  
  planilla_cazatalentos[ ids_juegan7,  tiros7 := tiros_7 ]  #registro en la planilla que tiran x tiros
  resultado7  <- gimnasio_tirar( ids_juegan7, tiros_7)
  planilla_cazatalentos[ ids_juegan7,  aciertos7 := resultado7 ]  #registro en la planilla
  
  #promedio con los tiros de las rondas anteriores
  
  planilla_cazatalentos$aciertos7=(planilla_cazatalentos$aciertos7*planilla_cazatalentos$tiros7+
                                     planilla_cazatalentos$aciertos6*
                                     (planilla_cazatalentos$tiros1
                                      +planilla_cazatalentos$tiros2
                                      +planilla_cazatalentos$tiros3
                                      +planilla_cazatalentos$tiros4
    ...
    (planilla_cazatalentos$tiros1
     ...
     +planilla_cazatalentos$tiros5
     +planilla_cazatalentos$tiros6
     +planilla_cazatalentos$tiros7)
  #-------------------------------------------------------------------------------
  
  #Epilogo
  #El cazatalentos toma una decision, elige al que mas aciertos tuvo en la ronda2
  pos_mejor <-  planilla_cazatalentos[ , which.max(aciertos7) ]
...
cat("t=",t,"m=",m,"tiros_total=",tiros_total,"tasa_eleccion_correcta=",tasa_eleccion_correcta)
